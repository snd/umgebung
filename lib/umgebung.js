...
optionsToConfig = function(options) {
  ...
  config.prefixWordArray = helfer.splitCamelcase(options.prefix || 'env');
  config.maybePrefixWordArray = helfer.splitCamelcase(options.maybePrefix || 'maybe');
  config.typeHandlers = {};
...
configure = function(options) {
  ...
  return function(key) {
    var factory, parsed;
    if (key === config.envDependencyName) {
      return function() {
        return config.env;
      };
    }
